 ...
 * @author Angelmath
 */
public class analogo extends javax.swing.JDialog {
    
    /**
     * Creates new form base
     */
    public analogo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dispose();
        setUndecorated(true);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("INGRESO DE CAMARA ANALOGA");
        ...
        jTextField2.setBounds(280, 230, 180, 30);
        ...
        jTextField5.setBounds(280, 280, 180, 30);
        ...
        jTextField6.setBounds(280, 330, 180, 30);
        ...
        jTextField9.setBounds(280, 130, 180, 30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(analogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                analogo dialog = new analogo(new javax.swing.JFrame(), true);
