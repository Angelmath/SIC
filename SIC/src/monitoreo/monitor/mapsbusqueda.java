 ...
 * @author Angelmath
 */
public class mapsbusqueda extends javax.swing.JDialog {
    
    /**
     * Creates new form base
     */
    public mapsbusqueda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dispose();
        setUndecorated(true);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Coordenadas Maps");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mapsbusqueda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                mapsbusqueda dialog = new mapsbusqueda(new javax.swing.JFrame(), true);
