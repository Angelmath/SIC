 ...
 * @author Angelmath
 */
public class estatico extends javax.swing.JDialog {
    
    /**
     * Creates new form base
     */
    public estatico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dispose();
        setUndecorated(true);
    ...
    private void initComponents() {
        ...
        jTextField8.setBounds(280, 150, 180, 30);
        ...
        jTextField9.setBounds(280, 100, 180, 30);
        ...
        jScrollPane1.setBounds(70, 210, 390, 170);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estatico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                estatico dialog = new estatico(new javax.swing.JFrame(), true);
