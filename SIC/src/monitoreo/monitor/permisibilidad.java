 ...
 * @author Angelmath
 */
public class permisibilidad extends javax.swing.JDialog {
    
    /**
     * Creates new form base
     */
    public permisibilidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dispose();
        setUndecorated(true);
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(70, 240, 390, 170);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(permisibilidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                permisibilidad dialog = new permisibilidad(new javax.swing.JFrame(), true);
