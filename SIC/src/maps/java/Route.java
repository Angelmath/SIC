...
public class Route extends MapsJava{
    ...
    private ArrayList<Integer> waypointIndex=new ArrayList<Integer>();
    private ArrayList<Integer> totalTime=new ArrayList<Integer>();
    private ArrayList<Integer> totalDistance=new ArrayList<Integer>();
    private ArrayList<String> polilines=new ArrayList<String>();
...
//        }
    ...
    public String[][] getRoute(String originAddress, String destinationAddress, ArrayList<String> waypoints,
        ...
        try {
            ...
            ArrayList<NodeList> allNodes=new ArrayList<NodeList>();
