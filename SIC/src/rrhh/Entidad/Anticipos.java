...
public class Anticipos  implements java.io.Serializable {
    ...
    public Anticipos(int id) {
        this.id = id;
    }
    public Anticipos(int id, String motivo, String observacion, String valor, String accion, String ci, String mes, String anio, String responsable) {
       this.id = id;
       this.motivo = motivo;
