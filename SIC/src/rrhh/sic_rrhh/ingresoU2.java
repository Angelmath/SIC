 ...
 * @author Angelmath
 */
public class ingresoU2 extends javax.swing.JDialog {
    Departamento marc;
    /**
     * Creates new form ingresoU
     */
    public ingresoU2(java.awt.Frame parent, boolean modal,ArrayList<Double> dou,ArrayList<Double> dou2,ArrayList<Double> dou3, ArrayList<String> fech, ArrayList<String> fech2, ArrayList<String> fech3,ArrayList<Integer> n1,ArrayList<Integer> n2,ArrayList<Integer> n3, String depa) {
        super(parent, modal);
        initComponents();
        setSize(800,380);
        dispose();
        ...
        for(int i=0; i<dou.size();i++){
            ...
            jTable1.getModel().setValueAt(fech.get(i), i, 0);
            jTable1.getModel().setValueAt(n1.get(i), i, 1);
            jTable1.getModel().setValueAt("$" +dou.get(i), i, 2);
            jTable1.getModel().setValueAt(n2.get(i), i, 3);
            jTable1.getModel().setValueAt("$" +dou2.get(i), i, 4);
            jTable1.getModel().setValueAt(n3.get(i), i, 5);
            jTable1.getModel().setValueAt("$" +dou3.get(i), i, 6);
        }
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha", "N°", "Total Leve", "N°", "Total Media", "N°", "Total Grave"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class
            };
        ...
        jScrollPane1.setBounds(30, 70, 730, 210);
        ...
        jButton4.setBounds(320, 320, 49, 29);
        getContentPane().add(jLabel3);
        jLabel3.setBounds(510, 20, 210, 30);

        jLabel2.setFont(new java.awt.Font("Roboto Light", 3, 18)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Tabla de Multas");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(90, 20, 330, 30);
 ...
 public void empleados(){    
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ingresoU2 dialog = new ingresoU2(new javax.swing.JFrame(), true, null,null,null,null,null,null,null,null,null,null);
