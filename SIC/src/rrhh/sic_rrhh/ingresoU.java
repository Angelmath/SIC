...
public class ingresoU extends javax.swing.JDialog {
     ...
     */
    public ingresoU(java.awt.Frame parent, boolean modal, Departamento marc,String campo1, String campo2, String campo3) {
        super(parent, modal);
        initComponents();
        setSize(505,320);
        dispose();
        ...
        jComboBox2.setSelectedItem(campo1);
        jTextField8.setText(campo2);
        jTextField2.setText(campo3);
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jTextField2.setBounds(280, 170, 180, 30);
        ...
        jButton1.setBounds(180, 240, 49, 29);
        ...
        jComboBox2.setBounds(280, 110, 180, 30);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try {
            ...
            marc.setEmpleado((Empleado)jComboBox1.getItemAt(jComboBox2.getSelectedIndex()));
            marc.setNombre(jTextField8.getText());
            helper.crearOrActualizarObjeto(marc);
 ...
 public void empleados(){
        try{
            ...
            helper.iniciarTransaccion();
            List<Empleado> list = helper.getPersonasByTipo();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ingresoU dialog = new ingresoU(new javax.swing.JFrame(), true, null,null,null,null);
