 ...
 * @author Angelmath
 */
public final class ingresoU3 extends javax.swing.JDialog {
    marco padre;
    instalacion empl;
    String cl;
    int toca;
     ...
     * @param nivel
     */
    public ingresoU3(java.awt.Frame parent, marco padre, boolean modal, instalacion log,String cl,int tipo,Login nivel, int cliente) {
        super(parent, modal);
        initComponents();
        this.padre=padre;
        this.cl=cl;
        ...
        this.empl=log;         
        setSize(510,420);
        if(!nivel.getNivel().equalsIgnoreCase("Administrador")){
        ...
        try {
            ...
            Clientes client = (Clientes) neo.obtenerObjeto(Clientes.class,cliente);
            if(client!=null){
                    if(toca!=1){
                        if(client.getLogin2()!=null){
                            if(client.getLogin2().getId()==nivel.getId()){
                                jComboBox1.removeAllItems();
                                jComboBox1.addItem("Soporte Técnico");
                                jComboBox1.addItem("Venta Directa");
                                jComboBox1.addItem("Poligrafos");
                                jComboBox1.addItem("Guardianía");
                            }
                        }
                        if(client.getLogin3()!=null){
                            if(client.getLogin3().getId()==nivel.getId()){
                                jComboBox1.removeAllItems();
                                jComboBox1.addItem("Instalación");
                                jComboBox1.addItem("Soporte Técnico");
                            }
                        }
                    }
            ...
            Logger.getLogger(ingresoU3.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        in.setFecha(Funcion.DateFormat(getjDateChooser1().getDate()));
        ...
        nuevo.setFecha(Funcion.DateFormat(getjDateChooser1().getDate()));
    ...
    public boolean validacion(){
        ...
        if(getjDateChooser1().getDate()==null){
            JOptionPane.showConfirmDialog(null, "Fecha de la Instalacion no Ingresada", "Info", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE);
            return false;
        }
...
public void alt (Component bt, String text){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ingresoU3 dialog = new ingresoU3(new javax.swing.JFrame(),null, true,null,null,0,null,0);
