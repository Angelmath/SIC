 ...
 * @author Angelmath
 */
public final class presentar1 extends javax.swing.JDialog {
    marco padre;
    instalacion empl;
    String cl;
    Login Usuario;
     ...
     */
    public presentar1(java.awt.Frame parent, marco padre, boolean modal,String modelo,String costo,Login user) {
        super(parent,modal);
        this.padre=padre;
        initComponents();  
        Items it=null;
        ...
        getjLabel4().setText(it.getCodigo());//id
        getjLabel6().setText(it.getMarca());//tipo        
        getjLabel8().setText(costo);//Valor
    ...
    private void initComponents() {
        ...
        jLabel7.setBounds(440, 60, 50, 40);

        jLabel8.setFont(new java.awt.Font("Roboto Light", 0, 10)); // NOI18N
        jLabel8.setText("N/A");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(590, 60, 170, 40);
  ...
  public Component getTableCellRendererComponent(JTable table, Object value,
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                presentar1 ingresoInventario = new presentar1(null, null, true,null,null,null);
            }
        });
    }
