 ...
 * @author Angelmath
 */
public final class retencionctecobrar extends javax.swing.JDialog {
    marco padre;
    instalacion empl;
    String cl;
    Login Usuario;
     ...
     * @param dou
     */
    public retencionctecobrar(java.awt.Frame parent, marco padre, boolean modal, Retencionfactu ret, String pago,Double dou) {
        super(parent,modal);
        this.padre=padre;
        this.ret=ret;
        this.pago=pago;
    ...
    public void suma(){
            ...
            if(!jTextField6.getText().isEmpty()){
                val1 = Float.parseFloat(jTextField6.getText());
            }
            if(!jTextField7.getText().isEmpty()){
                val2 = Float.parseFloat(jTextField7.getText());
            }
            if(!jTextField10.getText().isEmpty()){
                val3 = Float.parseFloat(jTextField10.getText());
            }
            if(!jTextField11.getText().isEmpty()){
                val4 = Float.parseFloat(jTextField11.getText());
            }
            if(!jTextField12.getText().isEmpty()){
                val5 = Float.parseFloat(jTextField12.getText());
            }
            if(!jTextField13.getText().isEmpty()){
                val6 = Float.parseFloat(jTextField13.getText());
            }
            if(!jTextField14.getText().isEmpty()){
                val7 = Float.parseFloat(jTextField14.getText());
            }
            DecimalFormat df = new DecimalFormat("#0.00");
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(330, 480, 49, 29);
        ...
        jButton1.setBounds(110, 480, 49, 29);
        ...
        jButton5.setBounds(220, 480, 49, 29);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try{
            if(ret!=null){
                ...
                ret.setValor10(jTextField11.getText());
            ...
            Ctecobrar cobro=null;
            try{
                ServiceHb helper = new ServiceHb();
                helper.iniciarTransaccion();
                cobro = (Ctecobrar)helper.obtenerObjeto(Ctecobrar.class, Integer.parseInt(pago));
                if(cobro!=null){
                    cobro.setTotalretencion(jTextField8.getText());
                    cobro.setNumretencion(jTextField4.getText());
                    cobro.setAutretencion(jTextField5.getText());
                    cobro.setIdretencion(""+ret.getId());
                }
                helper.crearOrActualizarObjeto(cobro);
                helper.confirmarTransaccion();
                helper.cerrarSesion();
            }catch(Exception io){} 
        ...
        if(selectedSiteName.equalsIgnoreCase("cajamarca")){
            try {
                ...
                try{
                    ...
                    cobro = (Ctecobrar)helper.obtenerObjeto(Ctecobrar.class, Integer.parseInt(pago));
                    if(cobro!=null){
                        cobro.setTotalretencion(null);
                        cobro.setNumretencion("0");
                        cobro.setAutretencion("");
                        cobro.setIdretencion("");
                    }
                    helper.crearOrActualizarObjeto(cobro);
                    helper.confirmarTransaccion();
                    helper.cerrarSesion();
                }catch(Exception io){} 
                JOptionPane.showMessageDialog(null,"Retencion Eliminada");
                dispose();
            } catch (Exception ex) {
            }
        }
