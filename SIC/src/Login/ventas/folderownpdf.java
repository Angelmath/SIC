 ...
 * @author Angelmath
 */
public class folderownpdf extends javax.swing.JDialog {
    marco marc;
    Login usuario;
    File grabado;
    /**
     ...
     * @param us
     */
    public folderownpdf(java.awt.Frame parent, boolean modal, String carpeta, Login us) {
        super(parent, modal);
        initComponents();
        setSize(505,360);
        dispose();
        ...
        jTextField2.setText(carpeta);
        jTextField3.setText(us.getNombre());
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jButton4.setBounds(300, 260, 49, 29);

        jLabel2.setFont(new java.awt.Font("Roboto Light", 3, 18)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("INGRESE NUEVO ARCHIVO PDF");
        ...
        jButton1.setBounds(180, 260, 49, 29);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if((grabado!=null)&&(!jTextField8.getText().isEmpty())){
            String carpeta=nombrecarpeta(jTextField2.getText());
            if(existpdf(carpeta,jTextField8.getText())){
                try{
                    Owncloud ow = new Owncloud();
                ...
                JOptionPane.showMessageDialog(null, "PDF Existen");
            }
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(folderownpdf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                folderownpdf dialog = new folderownpdf(new javax.swing.JFrame(), true,"",null);
